...
int main()
{
  ...
  do
  {
    ...
    if (check != EOF) // this is only to avoid the last item being added
    {
  ...
  double average = (sum + 0.0) / index; // +0.0 to convert to double and avoid integer division
